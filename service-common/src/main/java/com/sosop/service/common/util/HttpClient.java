...
public class HttpClient {
	...
	public static byte[] request(String urlPath, String method, String params, String contentType) {
		byte[] response = new byte[512];
		StringBuffer sb = new StringBuffer(urlPath);
		PrintWriter out = null;
		try {
			if(HttpClient.METHOD.GET.equalsIgnoreCase(method) && null != params) {
			...
			if(HttpClient.METHOD.POST.equalsIgnoreCase(method) && null != params) {
	...
	public static byte[] request(String urlPath, String method, Map<String, Object> params, String contentType) {
